...
Partial Class index
   ...
   Public Function IsAuthenticated(ByVal domain As String, ByVal username As String, ByVal pwd As String) As Boolean
    ...
    Protected Sub btn_login_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_login.Click
        ...
        Dim corpid As String = txt_corpid.Text.Trim
        ...
        if IsAuthenticated(domainName, corpid, password) Then
        Try
        conn.Open()
        oconn.Open()
                myCommand.Parameters.Clear()
                myCommand.CommandText = "Select * From Staff Where corpID = @corpid"
                myCommand.Parameters.AddWithValue("@corpid", corpid)
                ...
                myCommand1.CommandText = "Select * From normal_user Where corpid = @corpid"
                myCommand1.Parameters.AddWithValue("@corpid", corpid)
